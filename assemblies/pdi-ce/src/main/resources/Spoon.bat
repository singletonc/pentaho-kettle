...
@echo on
%SPOON_START_OPTION% "%_PENTAHO_JAVA%" %OPT% -jar launcher\pentaho-application-launcher-8.0-SNAPSHOT.jar -lib ..\%LIBSPATH% %_cmdline%
@echo off
