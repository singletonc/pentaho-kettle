...
import org.pentaho.di.engine.configuration.impl.spark.SparkRunConfigurationProviderFactory;
...
public class RunConfigurationProviderFactoryManager {
  ...
  /**
   * Generates (instantiates) a RunConfigurationProvider of each registered Factory type using the provided CheckedMetaStoreSupplier
